...
Welcome to ``fepredict`` contributor's guide.
...
If you experience bugs or general issues with ``fepredict``, please have a look
...
You can help improve ``fepredict`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``fepredict`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``fepredict``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/fepredict.git
    cd fepredict
...
#. Install |pre-commit|_::
   ...
   ``fepredict`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/fepredict
.. _issue tracker: https://github.com/<USERNAME>/fepredict/issues
.. <-- end -->
