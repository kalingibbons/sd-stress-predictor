...
2. activate the new environment with:
   ```
   conda activate fepredict
   ```

> **_NOTE:_**  The conda environment will have fepredict installed in editable mode.
...
2. Create concrete dependencies as `environment.lock.yml` for the exact reproduction of your
   environment with:
   ```bash
   conda env export -n fepredict -f environment.lock.yml
   ```
...
├── src
│   └── fepredict           <- Actual Python package where the main functionality goes.
